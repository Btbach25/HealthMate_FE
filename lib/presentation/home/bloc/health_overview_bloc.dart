...
class HealthOverviewBloc
  ...
  HealthOverviewBloc({
    ...
    if (_deviceCubit.lastPoints.isNotEmpty) {
      ...
      if (ov != null) {
        add(HealthOverviewDeviceLoaded(ov));
      }
    }
  ...
  Future<void> _onRetried(
    HealthOverviewRetried event,
    Emitter<HealthOverviewState> emit,
  ) async {
    add(const HealthOverviewRequested());
  }

  void _onDeviceLoaded(
    HealthOverviewDeviceLoaded event,
    Emitter<HealthOverviewState> emit,
  ) {
  ...
  void _onManualPatched(
    HealthOverviewManualPatched event,
    Emitter<HealthOverviewState> emit,
  ) {
